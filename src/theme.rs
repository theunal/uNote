...
pub fn colors(dark: bool) -> Win11Colors {
    if dark {
        Win11Colors {
            ...
            accent_strong: Color32::from_rgb(76, 194, 255),
            accent_soft: Color32::from_rgba_premultiplied(96, 205, 255, 36),
            accent_border: Color32::from_rgba_premultiplied(96, 205, 255, 140),
            danger_soft: Color32::from_rgba_premultiplied(255, 100, 100, 41),
        ...
        Win11Colors {
            ...
            accent_strong: Color32::from_rgb(16, 110, 190),
            accent_soft: Color32::from_rgba_premultiplied(0, 120, 212, 31),
            accent_border: Color32::from_rgba_premultiplied(0, 120, 212, 128),
            danger_soft: Color32::from_rgba_premultiplied(200, 50, 50, 36),
...
pub fn glass(dark: bool) -> Color32 {
    if dark {
        Color32::from_rgba_premultiplied(45, 45, 45, 199)
    } else {
        Color32::from_rgba_premultiplied(255, 255, 255, 204)
    }
}

pub fn glass_strong(dark: bool) -> Color32 {
    if dark {
        Color32::from_rgba_premultiplied(50, 50, 50, 240)
    } else {
...
pub fn apply_win11_style(ctx: &egui::Context, dark: bool) {
    ...
    style.visuals.widgets.noninteractive.corner_radius = cr6;
    ...
    style.visuals.widgets.inactive.corner_radius = cr6;
    ...
    style.visuals.widgets.hovered.corner_radius = cr6;
    ...
    style.visuals.widgets.active.corner_radius = cr6;
    ...
    style.visuals.widgets.open.corner_radius = cr6;
    ...
    visuals.widgets.noninteractive.corner_radius = cr6;
    ...
    visuals.widgets.inactive.corner_radius = cr6;
    ...
    visuals.widgets.hovered.corner_radius = cr6;
    ...
    visuals.widgets.active.corner_radius = cr6;
    ...
    visuals.widgets.open.corner_radius = cr6;
